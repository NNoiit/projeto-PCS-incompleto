...
form.addEventListener('submit'), (event) => {
    ...
    if(nome == ""|| email == ""|| cpf == ""|| matricula ==""||senha== ""){
        ...
        usuarios.add(dados).then((docRef) => {
            form.reset();
            document.getElementById("msg-perfil").innerHTML = "Usuario cadastrado com exito"
        })
        .cotch((error) => {
            document.getElementById("msg-perfil").innerHTML = "Usuario cadastrado não realizado"
        })
    }
}